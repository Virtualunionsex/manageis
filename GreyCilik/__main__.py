...
CILIK_IMG = "https://telegra.ph/file/5644c5ca4a474438ab9fc.jpg"
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(text="🧸 Owner", url="https://t.me/azure_id"),
                            InlineKeyboardButton(text="Support 🚀", url="https://t.me/nakama_asl"),
                        ],                        
                        [
                        ...
                        [
                            InlineKeyboardButton(
                                text=gs(chat.id, "add_bot_to_group_button"), url="https://t.me/hancock_robot?startgroup=new"),
                        ]
                    ]
                ),
                parse_mode=ParseMode.MARKDOWN,
